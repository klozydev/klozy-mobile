...
void main() {
  ...
  group('ProfilePage — guest-tab gating', () {
    ...
    // Note: the valid-state path renders ProfileView which calls locator<ProfileBloc>()
    // — requires full DI/Firebase setup unavailable in unit tests.
