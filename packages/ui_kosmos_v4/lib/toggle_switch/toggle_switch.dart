...
///
class KosmosToggleSwitch extends ConsumerStatefulWidget {
  final List<ItemModel> listItems;
  final void Function(ItemModel)? onChanged;
  ...
  @override
  ConsumerState<KosmosToggleSwitch> createState() => KosmosToggleSwitchState();
}

class KosmosToggleSwitchState extends ConsumerState<KosmosToggleSwitch> {
